...
// la accesarea adresei .../delete{id} (cu metoda get), vom accesa clasa ItemController importata de mai sus si vom apela functia Delete()
Route::get("/delete/{id}", [ItemController::class, "Delete"]);

// la accesarea adresei .../delete{id} (cu metoda deelte),
// vom accesa clasa ItemController importata de mai sus si vom apela functia DeleteItem()
Route::delete("/delete", [ItemController::class, "DeleteItem"]);